...
public class QuartoInternalFrame extends javax.swing.JInternalFrame {
    ...
    private void tableQuartoInternalFrameMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableQuartoInternalFrameMousePressed
        ...
        if(tableQuartoInternalFrame.getSelectedRow() >= -1){            
            ...
            int i = 0;            
            while(!(auxQuarto.getTipo().equals(tipoQuartoComboBox.getItemAt(i))) && (i < tipoQuartoComboBox.getModel().getSize()) ){
                i++;
            }
    ...
    private void btnDeleteMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeleteMousePressed
        ...
        if(btnDelete.isEnabled()){
            ...
            if(!(txtID.getText().isEmpty() && (auxQuarto.getIdQuarto()< 0))){                                
                try {
                    quartoJpaController.destroy(auxQuarto.getIdQuarto());
                    ...
                    tableQuartoInternalFrame.revalidate();
    ...
    private void btnUpdateMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMousePressed
        ...
        if(btnUpdate.isEnabled()){
            if(!(txtID.getText().isEmpty() && (auxQuarto.getIdQuarto()< 0))){
                ...
                auxQuarto.setTipo((TipoQuarto) tipoQuartoComboBox.getSelectedItem());
                auxQuarto.setCapacidade(Integer.parseInt(capacidadeComboBox.getSelectedItem().toString()));
                try {
                    quartoJpaController.edit(auxQuarto);
    ...
    private void btnAddMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddMousePressed
        ...
        if(btnAdd.isEnabled()){
            if(!(txtDescricao.getText().isEmpty())){
                ...
                quarto.setDescricaoQuarto(txtDescricao.getText());
                quarto.setTipo((TipoQuarto) tipoQuartoComboBox.getSelectedItem());
                quarto.setCapacidade(Integer.parseInt(capacidadeComboBox.getSelectedItem().toString()));
                try {
                    quartoJpaController.create(quarto);
